          ...
          async (error) => {
            ...
            if (error.response && (error.response.status === 401 || error.response.status === 403)) {
              try {
                ...
                await axios.post("http://localhost:5000/clearCookie",user); //ei kaj chaile authProvider.jsx ew kora jaito.
...
//             await logOut();
//             await axios.post("http://localhost:5000/clearCookie",user);
//             navigate('/login');
//         }
